...
// ---------------- TEXT MODULES (outside any function!) ----------------

const SIGN_TEXT = {
  Ram: {
    core: "Gedreven, initiatiefrijk en gericht op directe actie en zelfexpressie.",
    emotion: "Emoties worden direct en impulsief ervaren en snel geuit.",
    relation: "Zoekt levendigheid, eerlijkheid en ruimte om zichzelf te zijn.",
    action: "Handelt snel, doelgericht en neemt graag het voortouw."
  },
  Stier: {
    core: "Gericht op stabiliteit, zekerheid en het opbouwen van een solide basis.",
    emotion: "Emoties zijn diep en standvastig, met behoefte aan rust en veiligheid.",
    relation: "Hecht waarde aan trouw, fysieke nabijheid en continuïteit.",
    action: "Handelt bedachtzaam en volhardend, met focus op lange termijn."
  },
  Tweelingen: {
    core: "Nieuwsgierig, communicatief en mentaal flexibel ingesteld.",
    emotion: "Emoties worden rationeel benaderd en verbaal verwerkt.",
    relation: "Zoekt verbinding via gesprek, humor en intellectuele uitwisseling.",
    action: "Handelt veelzijdig en past zich snel aan veranderende omstandigheden aan."
  },
  Kreeft: {
    core: "Gevoelig, zorgzaam en sterk verbonden met innerlijke beleving.",
    emotion: "Emoties zijn intens en worden ervaren vanuit veiligheid en geborgenheid.",
    relation: "Zoekt emotionele verbondenheid, vertrouwen en wederzijdse zorg.",
    action: "Handelt vanuit gevoel en beschermingsdrang."
  },
  Leeuw: {
    core: "Expressief, creatief en gericht op zelfontplooiing en zichtbaarheid.",
    emotion: "Emoties worden warm, loyaal en vanuit het hart beleefd.",
    relation: "Heeft behoefte aan waardering, speelsheid en oprechte aandacht.",
    action: "Handelt met zelfvertrouwen en natuurlijke leiderschapsdrang."
  },
  Maagd: {
    core: "Analytisch, praktisch en gericht op verbetering en verfijning.",
    emotion: "Emoties worden zorgvuldig geanalyseerd en innerlijk verwerkt.",
    relation: "Zoekt betrouwbaarheid, duidelijkheid en wederzijdse inzet.",
    action: "Handelt nauwkeurig, dienstbaar en doelgericht."
  },
  Weegschaal: {
    core: "Gericht op harmonie, balans en verbinding met anderen.",
    emotion: "Emoties worden gespiegeld via relaties en sociale interactie.",
    relation: "Zoekt gelijkwaardigheid, esthetiek en wederzijds begrip.",
    action: "Handelt diplomatiek en afwegend."
  },
  Schorpioen: {
    core: "Intens, onderzoekend en gericht op diepgang en transformatie.",
    emotion: "Emoties zijn krachtig en worden vaak innerlijk beleefd.",
    relation: "Zoekt emotionele diepte, loyaliteit en oprechte betrokkenheid.",
    action: "Handelt vastberaden en met sterke innerlijke motivatie."
  },
  Boogschutter: {
    core: "Optimistisch, vrijheidslievend en gericht op zingeving.",
    emotion: "Emoties worden benaderd vanuit vertrouwen en toekomstgerichtheid.",
    relation: "Zoekt ruimte, groei en gedeelde idealen.",
    action: "Handelt enthousiast en vanuit visie."
  },
  Steenbok: {
    core: "Ambitieus, verantwoordelijk en gericht op structuur en realisatie.",
    emotion: "Emoties worden gecontroleerd en praktisch benaderd.",
    relation: "Zoekt betrouwbaarheid, respect en gezamenlijke doelen.",
    action: "Handelt planmatig en vol discipline."
  },
  Waterman: {
    core: "Onafhankelijk, vernieuwend en gericht op originaliteit.",
    emotion: "Emoties worden rationeel benaderd en op afstand verwerkt.",
    relation: "Zoekt vrijheid, gelijkwaardigheid en mentale verbinding.",
    action: "Handelt vernieuwend en volgens eigen overtuigingen."
  },
  Vissen: {
    core: "Intuïtief, empathisch en gevoelig voor subtiele indrukken.",
    emotion: "Emoties worden diep en meevoelend ervaren.",
    relation: "Zoekt verbinding op zielsniveau en emotionele resonantie.",
    action: "Handelt vanuit intuïtie en innerlijke beleving."
  }
};
...
const LIFE_PATH_TEXT = {
  ...
  7: "Levenspad 7 draait om verdieping, analyse en innerlijke waarheid zoeken.",
  8: "Levenspad 8 draait om kracht, leiding, manifestatie en gezond omgaan met ambitie.",
  9: "Levenspad 9 draait om compassie, afronding en betekenisvol bijdragen.",
  11: "Levenspad 11 (master) draait om intuïtie, inspiratie en het verwoorden van inzichten.",
...
function makeCoreSentence(sunSign, ascSign, lifePath) {
  return `Deze persoon combineert de kernkwaliteit van ${sunSign} met een naar buiten gerichte stijl van ${ascSign}. ${makeNumerologyThread(lifePath)}`;
}
...
function generatePdf() {
  ...
  if (totalPages >= 5) {
    ...
    const talent = JUPITER_TEXT[jupiterSign] || "Groei komt via ontwikkeling van talent, vertrouwen en het benutten van kansen.";
    const lesson = SATURN_TEXT[saturnSign] || "De les is volwassen worden in grenzen, discipline en het bouwen van structuur.";
    const numThread = makeNumerologyThread(numerology.lifePath);
